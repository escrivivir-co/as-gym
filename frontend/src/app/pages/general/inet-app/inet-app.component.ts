...
import { SnakeGameComponent } from '../../application/feature/snake/snake.component';
...
@Component({
	selector: 'app-inet-app',
	standalone: true,
	imports: [LoggerComponent, CommonModule, RouterLink, RouterOutlet,
		PrettyJsonPipeV2, DynamicFormComponent,
		SnakeGameComponent, BotoneraComponent, PantallaComponent],
	templateUrl: './inet-app.component.html',
	styleUrl: './inet-app.component.css',
...
export class InetAppComponent implements OnInit {
